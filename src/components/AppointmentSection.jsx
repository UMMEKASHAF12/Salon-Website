...
const AppointmentForm = () => {
  return (
    <section className="py-32 px-6 md:px-20 bg-[#f7f4f2]">
      <motion.div
        variants={container}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true, amount: 0.3 }}
        className="max-w-4xl mx-auto bg-white rounded-[40px] shadow-2xl p-10 md:p-16"
      >
        {/* Heading */}
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.select variants={item} className="input-style">
